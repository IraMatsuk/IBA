...
/**
 * The type Sort products by name command.
 */
public class SortProductsByNameCommand implements CustomCommand {
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            List<Product> productsInStock = service.findAllProductsInStockFromDbAndSortByName();
