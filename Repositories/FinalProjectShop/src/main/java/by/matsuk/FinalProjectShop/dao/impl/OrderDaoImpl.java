...
import by.matsuk.FinalProjectShop.entity.*;
...
public class OrderDaoImpl implements OrderDao {
    ...
    private static final String SQL_SELECT_ALL_COMPLETE_ORDERS = """
            ...
            complete_orders.complete_order_date, complete_orders.is_completed FROM complete_orders 
            JOIN users ON complete_orders.user_id = users.user_id""";
    ...
    private static final String SQL_SELECT_ALL_COMPLETE_ORDERS_AND_SORT_BY_USER_LOGIN = """
            SELECT complete_orders.complete_order_id, users.login, users.email, users.is_active,
            complete_orders.complete_order_date, complete_orders.is_completed FROM complete_orders 
            JOIN users ON complete_orders.user_id = users.user_id ORDER BY users.login ASC""";
    private static final String SQL_SELECT_ALL_COMPLETE_ORDERS_AND_SORT_BY_DATE = """
            SELECT complete_orders.complete_order_id, users.login, users.email, users.is_active,
            complete_orders.complete_order_date, complete_orders.is_completed FROM complete_orders 
            JOIN users ON complete_orders.user_id = users.user_id 
            ORDER BY complete_orders.complete_order_date ASC""";
