package by.matsuk.FinalProjectShop.dao.impl;
...
public class ProductDaoImpl implements ProductDao {
    ...
    private static final String SQL_SELECT_ALL_PRODUCTS = """
            SELECT products.product_id, products.product_name, products.product_price, products.is_in_stock,
    ...
    private static final String SQL_SELECT_PRODUCTS_IN_STOCK_AND_SORT_BY_NAME = """
            SELECT products.product_id, products.product_name,
            products.product_price, products.is_in_stock,
            products.picture_path, products.product_comment, products.product_category_id, product_categories.category FROM products 
            JOIN product_categories ON products.product_category_id = product_categories.category_id 
            WHERE products.is_in_stock = true ORDER BY products.product_name ASC""";
    private static final String SQL_SELECT_PRODUCTS_IN_STOCK_AND_SORT_BY_CATEGORY = """
            SELECT products.product_id, products.product_name, products.product_price, products.is_in_stock,
            products.picture_path, products.product_comment, products.product_category_id, product_categories.category FROM products 
            JOIN product_categories ON products.product_category_id = product_categories.category_id 
            WHERE products.is_in_stock = true ORDER BY product_categories.category ASC""";
    private static final String SQL_SELECT_PRODUCTS_IN_STOCK_AND_SORT_BY_PRICE = """
            SELECT products.product_id, products.product_name,
            products.product_price, products.is_in_stock,
            products.picture_path, products.product_comment, products.product_category_id, product_categories.category FROM products 
            JOIN product_categories ON products.product_category_id = product_categories.category_id 
            WHERE products.is_in_stock = true ORDER BY products.product_price ASC""";
