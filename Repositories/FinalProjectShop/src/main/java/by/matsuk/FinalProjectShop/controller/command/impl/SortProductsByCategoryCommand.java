...
/**
 * The type Sort products by category command.
 */
public class SortProductsByCategoryCommand implements CustomCommand {
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            List<Product> productsInStock = service.findAllProductsInStockFromDbAndSortByCategory();
