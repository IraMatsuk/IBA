...
/**
 * The type Sort orders by login command.
 */
public class SortOrdersByLoginCommand implements CustomCommand {
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            List<CompleteOrder> orders = orderService.findAllOrdersFromDbAndSortByLogin();
