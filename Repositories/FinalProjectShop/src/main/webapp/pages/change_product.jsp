...
<div class="container">
    ...
    <div class="row" style="margin-top: 60px" align="center">
        ...
        <form method="post" action="${pageContext.request.contextPath}/controller" name="add_product_form"
            ...
            <input type="hidden" id="product_id" name="product_id" value="${product_for_change_data.product_id}"
                   required="required"/>
            <div class="mb-3 w-25" style="margin-top: 40px">
                <label for="name" class="form-label"><fmt:message key="main_client.prod_name"/></label>
                <input type="text" class="form-control" id="name" name="name" value="${product_for_change_data.name}"
                       required="required"/>
            </div>
            <div class="mb-3 w-25" style="margin-top: 40px">
                ...
                <input type="number" min="1" step="0.01" class="form-control" id="price"
                       value="${product_for_change_data.price}" name="price" required="required"/>
            </div>
            <div class="mb-3 w-25" style="margin-top: 40px">
            ...
            <div class="mb-3 w-25" style="margin-top: 40px">
                ...
                <textarea class="form-control" id="comment" name="comment" rows="3"
                          required="required">${product_for_change_data.comment}</textarea>
            </div>
            ...
            <button type="submit" id="submitButton" class="btn btn-outline-warning"><fmt:message
                    key="main_admin.change_product"/></button>
        </form>
    </div>
