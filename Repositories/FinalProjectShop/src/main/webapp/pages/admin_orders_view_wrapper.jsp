...
<form method="post" action="${pageContext.request.contextPath}/controller" name="get_prod_data_wrapper">
    <input type="hidden" name="command" id="command" value="prepare_view_orders_page">
</form>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/main_client_wrapper_form_autosubmitter.js"></script>
</body>
</html>