            ...
            <div class="col-4">
                <form action="${pageContext.request.contextPath}/controller" method="post">
                    ...
                    <select class="form-select" name="command" id="command4" aria-label="Default select example"
                        ...
                        <option value="sort_orders_by_user_login"><fmt:message
                                key="main_admin.sort_orders_by_login"/></option>
                    </select>
                    <button type="submit" class="btn btn-outline-success btn-sm" style="margin-top: 20px"><fmt:message
                            key="main_admin.sort_orders"/></button>
                </form>
            </div>
            <div class="col-4">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="staticBackdropLabel4"><fmt:message
                                        key="main_admin.search_order"/></h5>
                            ...
                            <div class="modal-body">
                                ...
                                <form action="${pageContext.request.contextPath}/controller" method="post">
                                    ...
                                    <div class="mb-3 w-25" style="margin-top: 40px" width="300px">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id="login"
                                               name="login"/>
                                    </div>
                                    <div class="mb-3 w-25" style="margin-top: 40px" width="300px">
                                        <label for="completion_status" class="form-label"><fmt:message
                                                key="main_admin.product_status"/></label>
                                        <select class="form-select" id="completion_status" name="completion_status"
                                                aria-label="Default select example">
                                            <option value="-" selected="selected">-</option>
                                            <option value="completed"><fmt:message
                                                    key="main_admin.completed_status_completed"/></option>
                                            <option value="in_progress"><fmt:message
                                                    key="main_admin.completed_status_not_completed"/></option>
                                        </select>
                                    </div>
                                    <div class="mb-3 w-25" style="margin-top: 40px" width="300px">
                                        <label for="start_date" class="form-label"><fmt:message
                                                key="main_admin.enter_order_start_date"/></label>
                                        <input type="date" class="form-control" id="start_date" name="start_date"/>
                                    </div>
                                    <div class="mb-3 w-25" style="margin-top: 40px" width="300px">
                                        <label for="end_date" class="form-label"><fmt:message
                                                key="main_admin.enter_order_end_date"/></label>
                                        <input type="date" class="form-control" id="end_date" name="end_date"/>
                                    </div>
                                    <button type="submit" class="btn btn-outline-success btn-sm"
                                            style="margin-top: 20px"><fmt:message
                                            key="main_admin.search_order"/></button>
                                </form>
                            </div>
    ...
    <div class="row" style="margin-top: 20px">
        <form method="post" action="${pageContext.request.contextPath}/controller">
            ...
            <button type="submit" class="btn btn-outline-primary"><fmt:message
                    key="main_admin.products_selling_statistics"/></button>
        </form>
    </div>
    <div class="row" style="margin-top: 20px">
        <form method="post" action="${pageContext.request.contextPath}/controller">
