...
<div class="container">
            ...
            <div class="col-4">
                <form method="post" action="${pageContext.request.contextPath}/controller">
                    ...
                    <button type="submit" class="btn btn-outline-primary"><fmt:message
                            key="main_admin.enter_menu"/></button>
                </form>
            </div>
            <div class="col-4">
                <div class="row">
                    ...
                    <div class="col-4">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel"><fmt:message
                                                key="main_client.profile"/> ${pageContext.session.getAttribute("login")}</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-4">
                                                <div>
                                                    <a href="${pageContext.request.contextPath}/pages/authorization.jsp"
                                                       style="width: 160px" class="btn btn-primary btn-sm"><fmt:message
                                                            key="main_client.login_profile"/></a>
                                                </div>
                                                <br/>
                                                <div style="margin-top: 20px">
                                                    <a href="${pageContext.request.contextPath}/pages/registration.jsp"
                                                       style="width: 160px" class="btn btn-primary btn-sm"><fmt:message
                                                            key="main_client.reg_profile"/></a>
                                                </div>
                                                <br/>
                                                <form method="post"
                                                    ...
                                                    <button type="submit" style="width: 160px"
                                                        ...
                                                        <fmt:message key="main_client.logout_profile"/></button>
                                                </form>
                                            </div>
                                            <div class="col-4">
                                                <div style="margin-left: 140px">
                                                    <button class="btn btn-primary btn-sm" style="width: 160px"
                                                        ...
                                                        <fmt:message key="main_client.change_login"/></button>
                                                </div>
                                                <br/>
                                                <div style="margin-top: 20px; margin-left: 140px">
                                                    <button class="btn btn-primary btn-sm" style="width: 160px"
                                                            data-bs-target="#staticBackdrop3" data-bs-toggle="modal">
                                                        <fmt:message key="main_client.change_password"/></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                            <fmt:message key="main_client.close_window"/></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel2"><fmt:message
                                                key="main_client.change_login"/></h5>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="${pageContext.request.contextPath}/controller">
                                            <input type="hidden" name="command" id="command2" value="change_login"
                                                   required="required"/>
                                            <div class="mb-3 w-25" style="margin-top: 40px">
                                                <label for="loginOrEmail" class="form-label"><fmt:message
                                                        key="user_form.enter_login"/></label>
                                                <input type="text" class="form-control" id="loginOrEmail" name="login"
                                                       required="required"/>
                                            </div>
                                            <button type="submit" class="btn btn-outline-success btn-lg"
                                                    style="margin-top: 40px"><fmt:message
                                                    key="main_client.change_login"/></button>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                        ...
                        <div class="modal fade" id="staticBackdrop3" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel3"><fmt:message
                                                key="main_client.change_password"/></h5>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="${pageContext.request.contextPath}/controller">
                                            <input type="hidden" name="command" id="command3" value="change_password"
                                                   required="required"/>
                                            <div class="mb-3 w-25" style="margin-top: 40px">
                                                <label for="password" class="col-form-label"><fmt:message
                                                        key="user_form.enter_password"/></label>
                                            </div>
                                            <div class="mb-3 w-25">
                                            ...
                                            <button type="submit" class="btn btn-outline-success btn-lg"
                                                    style="margin-top: 40px"><fmt:message
                                                    key="main_client.change_password"/></button>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
    ...
    <div class="row" style="margin-top: 40px">
        <div class="col-4">
            <form action="${pageContext.request.contextPath}/controller" method="post">
                ...
                <select class="form-select" name="command" id="command4" aria-label="Default select example"
                        required="required">
                ...
                <button type="submit " class="btn btn-outline-success btn-sm" style="margin-top: 20px"><fmt:message
                        key="main_client.sort"/></button>
            </form>
        </div>
        <div class="col-4">
            <button type="button" class="btn btn-outline-success btn-sm" style="margin-top: 82px; margin-left: -300px"
            ...
            <div class="modal fade" id="staticBackdrop4" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel4"><fmt:message
                                    key="main_client.search"/> ${pageContext.session.getAttribute("login")}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p><fmt:message key="main_client.search_explanation"/></p>
                            <form action="${pageContext.request.contextPath}/controller" method="post">
                                <input type="text" id="command5" name="command" hidden="hidden" required="required"
                                       value="find_product"/>
                                <div class="mb-3 w-25" style="margin-top: 40px" width="160px">
                                    <label for="name" class="form-label"><fmt:message
                                            key="main_client.prod_name"/></label>
                                    <input type="text" maxlength="100" class="form-control" id="name" name="name"/>
                                </div>
                                <div class="mb-3 w-25" style="margin-top: 40px" width="160px">
                                    <label for="categories" class="form-label"><fmt:message
                                            key="main_client.prod_category"/></label>
                                    <select class="form-select" id="categories" name="category"
                                            aria-label="Default select example">
                                    </select>
                                </div>
                                <div class="mb-3 w-25" style="margin-top: 40px" width="160px">
                                    <label for="min_price" class="form-label"><fmt:message
                                            key="main_client.prod_price_min"/></label>
                                    <input type="number" min="0" class="form-control" id="min_price" name="min_price"/>
                                </div>
                                <div class="mb-3 w-25" style="margin-top: 40px" width="160px">
                                    <label for="max_price" class="form-label"><fmt:message
                                            key="main_client.prod_price_max"/></label>
                                    <input type="number" min="0" class="form-control" id="max_price" name="max_price"/>
                                </div>
                                <button type="submit" class="btn btn-outline-success btn-sm" style="margin-top: 20px">
                                    <fmt:message key="main_client.search"/></button>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><fmt:message
                                    key="main_client.close_window"/></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row" style="margin-top: 60px; margin-left: 300px">
        <div class="col-4">
            <button class="btn-warning" id="prev" type="button" onclick="prevPage()"><fmt:message
                    key="pagination.backwards"/></button>
        </div>
        <div class="col-4" style="color: darkorange; margin-left: -100px">
            <span id="page"></span>
        </div>
        <div class="col-4" style="margin-left: -150px">
            <button class="btn-warning" id="next" type="button" onclick="nextPage()"><fmt:message
                    key="pagination.forward"/></button>
        </div>
    </div>
</div>
</div>
