    ...
    <form action="${pageContext.request.contextPath}/controller" method="post">
        ...
        <div class="mb-3 w-25" style="margin-top: 40px">
            ...
            <input type="text" class="form-control" id="login" name="login"
                   value="${registration_form_data_map.form_login}" required="required"/>
        </div>
        <div class="mb-3 w-25" style="margin-top: 40px">
            <label for="email" class="form-label"><fmt:message key="user_form.enter_gmail"/></label>
            <input type="email" class="form-control" id="email" name="email"
                   value="${registration_form_data_map.form_email}" required="required"/>
        </div>
        <div class="mb-3 w-25" style="margin-top: 40px">
        ...
        <div class="mb-3 w-25">
            <input type="password" id="password" name="password" class="form-control"
                   value="${registration_form_data_map.form_password}" maxlength="20" minlength="8"
        ...
        <button type="submit " class="btn btn-outline-success btn-lg" style="margin-top: 40px"><fmt:message
                key="user_form.register"/></button>
    </form>
</div>
<div align="center" style="margin-top: 100px">
    <div style="color: red; font-weight: bolder; font-style: italic">${errorRegistrationMessage}</div>
    <a href="${pageContext.request.contextPath}/pages/authorization.jsp" class="text-black"><fmt:message
            key="user_form.login"/></a>
    <br/>
</div>
