        ...
        <div class="row justify-content-between">
            ...
            <div class="col-4">
                <div class="row">
                    ...
                    <div class="col-4">
                        <a href="${pageContext.request.contextPath}/index.jsp" style="width: 160px"
                           class="btn btn-primary btn-sm"><fmt:message key="user_form.catalog"/></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row" style="margin-top: 60px">
        <div class="row">
            <form method="post" action="${pageContext.request.contextPath}/controller">
                ...
                <button type="submit" class="btn btn-outline-warning btn-lg"><fmt:message
                        key="main_client.make_order"/></button>
            </form>
        </div>
    </div>
</div>
