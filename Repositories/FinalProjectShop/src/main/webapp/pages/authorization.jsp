    ...
    <form action="${pageContext.request.contextPath}/controller" method="post">
        ...
        <div class="mb-3 w-25" style="margin-top: 40px">
            ...
            <input type="text" class="form-control" id="loginOrEmail" name="login"
                   value="${login_form_data_map.form_login}" required="required"/>
        </div>
        <div class="mb-3 w-25" style="margin-top: 40px">
            <label for="password" class="form-label"><fmt:message key="user_form.enter_password"/></label>
            <input type="password" class="form-control" id="password" name="password"
                   value="${login_form_data_map.form_password}" required="required"/>
        </div>
        ...
        <button type="submit " class="btn btn-outline-success btn-lg" style="margin-top: 40px"><fmt:message
                key="user_form.login"/></button>
    </form>
</div>
<div align="center" style="margin-top: 160px">
    <div style="color: red; font-weight: bolder; font-style: italic">${errorAuthMessage}</div>
    <a href="${pageContext.request.contextPath}/pages/registration.jsp" class="text-black"><fmt:message
            key="user_form.register"/></a>
    <br/>
