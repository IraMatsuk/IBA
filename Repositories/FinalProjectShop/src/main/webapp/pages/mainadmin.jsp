...
<div class="container">
            ...
            <div class="col-4">
                <form action="${pageContext.request.contextPath}/controller" method="post">
                    ...
                    <button type="submit" class="btn btn-success btn-lg"><fmt:message
                            key="main_admin.add_product"/></button>
                </form>
            </div>
            <div class="col-4">
                <form action="${pageContext.request.contextPath}/controller" method="post">
                    ...
                    <select class="form-select" name="command" id="command4" aria-label="Default select example"
                        ...
                        <option value="find_in_stock_products"><fmt:message
                                key="main_admin.find_in_stock_products"/></option>
                        <option value="find_out_of_stock_stock_products"><fmt:message
                                key="main_admin.find_out_of_stock_products"/></option>
                    </select>
                    <button type="submit" class="btn btn-outline-success btn-sm" style="margin-top: 20px"><fmt:message
                            key="main_admin.find_products"/></button>
                </form>
            </div>
        </div>
    ...
    <div class="row" style="margin-top: 20px">
        ...
        <form method="post" action="${pageContext.request.contextPath}/controller">
            ...
            <button type="submit" class="btn btn-success btn-lg"><fmt:message
                    key="main_admin.view_all_orders"/></button>
        </form>
    </div>
</div>
</div>
